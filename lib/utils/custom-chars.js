  ...
  constructor(api) {
    ...
    this.uuids = {
      ...
      */
      ...
      extra1: 'E964F013-079E-48FF-8F27-9C2605A29F52',
      extra2: 'E964F014-079E-48FF-8F27-9C2605A29F52',
      extra3: 'E964F015-079E-48FF-8F27-9C2605A29F52',
      extra4: 'E964F016-079E-48FF-8F27-9C2605A29F52',
      extra5: 'E964F017-079E-48FF-8F27-9C2605A29F52',
      extra6: 'E964F018-079E-48FF-8F27-9C2605A29F52',
      extra7: 'E964F019-079E-48FF-8F27-9C2605A29F52',
      extra8: 'E964F020-079E-48FF-8F27-9C2605A29F52',
      extra9: 'E964F023-079E-48FF-8F27-9C2605A29F52',
      extra10: 'E964F024-079E-48FF-8F27-9C2605A29F52',
    ...
    inherits(this.Extra1, this.hapChar);
    inherits(this.Extra2, this.hapChar);
    inherits(this.Extra3, this.hapChar);
    inherits(this.Extra4, this.hapChar);
    inherits(this.Extra5, this.hapChar);
    inherits(this.Extra6, this.hapChar);
    inherits(this.Extra7, this.hapChar);
    inherits(this.Extra8, this.hapChar);
    inherits(this.Extra9, this.hapChar);
    inherits(this.Extra10, this.hapChar);
    ...
    this.Extra1.UUID = this.uuids.extra1;
    this.Extra2.UUID = this.uuids.extra2;
    this.Extra3.UUID = this.uuids.extra3;
    this.Extra4.UUID = this.uuids.extra4;
    this.Extra5.UUID = this.uuids.extra5;
    this.Extra6.UUID = this.uuids.extra6;
    this.Extra7.UUID = this.uuids.extra7;
    this.Extra8.UUID = this.uuids.extra8;
    this.Extra9.UUID = this.uuids.extra9;
    this.Extra10.UUID = this.uuids.extra10;
