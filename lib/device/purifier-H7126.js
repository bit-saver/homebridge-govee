...
export default class {
  ...
  async internalSpeedUpdate(value) {
    try {
      ...
      this.accessory.log(`[Air Purifier] speed value update: ${value} new value: ${newValue}`);
  ...
  externalUpdate(params) {
    ...
    (params.commands || []).forEach((command) => {
      ...
      // Return now if not a device query update code111
      ...
      this.accessory.log(`[Air purifier] command [${command}]: ${hexString}`)
